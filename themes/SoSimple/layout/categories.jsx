...
const TagsCategoriesLayout = ({ hexo: l, translateKey: r, dataSource: o })=>{
    let m = `${i18n(l, r)} · ${l.config.title}`, i = '', s = l.site[o].data.filter((t)=>t.name).sort((t, e)=>t.name < e.name ? -1 : 1), p = (t)=>/^[0-9]/.test(t) ? '0-9' : /^[a-zA-Z]/.test(t) ? t[0].toUpperCase() : '#', u = (t)=>{
        let e = i !== p(t.name);
        return i = p(t.name), e;
    };
    ...
    }, /*#__PURE__*/ h("h1", null, i18n(l, r)), s.map((a)=>/*#__PURE__*/ h("template", null, u(a) ? /*#__PURE__*/ h("h3", null, p(a.name)) : null, /*#__PURE__*/ h("span", null, /*#__PURE__*/ h("a", {
            href: l.url_for(a.path)
        }, escapeHtml(a.name)), " × ", a.length, "   "))));
};

var categories = withHexoData((t)=>/*#__PURE__*/ h(TagsCategoriesLayout, {
        hexo: t,
