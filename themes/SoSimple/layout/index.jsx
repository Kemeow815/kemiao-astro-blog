...
const PostExcerpt = ({ hexo: p, item: m })=>{
    let c = getThemeConfig(p), i = AsRecord(m).summary, l = c.style.post_excerpt.summary_mode ? i || p.strip_html(m.excerpt || m.content).slice(0, 160) : m.excerpt || i || m.content;
    return /*#__PURE__*/ h("article", {
        class: "post-container post-excerpt"
    }, /*#__PURE__*/ h("header", {
        class: "post-title"
    }, /*#__PURE__*/ h("h3", null, /*#__PURE__*/ h("a", {
        href: p.url_for(m.path)
    }, titleHTML(m, p.date(m.date, 'YYYY-MM-DD'))))), /*#__PURE__*/ h(PostMeta, {
        hexo: p,
        item: m
    }), /*#__PURE__*/ h("section", {
        class: "post-body"
...
var index = withHexoData((t)=>{
    var d, s, a;
    let m = AsRecord(t.page).posts.data, c = getThemeConfig(t), u = null === (a = t.site) || void 0 === a ? void 0 : null === (s = a.pages) || void 0 === s ? void 0 : null === (d = s.data) || void 0 === d ? void 0 : d.find((t)=>'index.md' === t.source);
    return /*#__PURE__*/ h(SharedLayout, {
        hexo: t,
        contentClass: "index-page"
    }, /*#__PURE__*/ h("header", {
        class: "post-container index-post"
    }, /*#__PURE__*/ h("h1", null, escapeHtml(t.config.title)), c.description ? /*#__PURE__*/ h("div", {
        class: "description"
    }, /*#__PURE__*/ h("p", null, c.description)) : null, (null == u ? void 0 : u.content) && /*#__PURE__*/ h("div", {
        class: "index-content"
    }, u.content)), m.filter((t)=>!0 !== t.hidden).map((o)=>/*#__PURE__*/ h(PostExcerpt, {
            hexo: t,
            item: o
