...
var TagCategoryLayout = function(param) {
    var hexo = param.hexo, translateKey = param.translateKey, name = param.name;
    var title = "".concat(i18n(hexo, translateKey), " \xb7 ").concat(name, " \xb7 ").concat(hexo.config.title);
    ...
    }, /*#__PURE__*/ h("h1", null, i18n(hexo, translateKey), " \xb7 ", name), /*#__PURE__*/ h(PostList, {
        hexo: hexo,
        item: hexo.page
...
var category = withHexoData(function(hexo) {
    return /*#__PURE__*/ h(TagCategoryLayout, {
        hexo: hexo,
        name: AsRecord(hexo.page).category,
