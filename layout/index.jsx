...
function h(elem, attrs) {
    ...
    var str = typeof elem === 'string' ? h_str.apply(void 0, [
        elem,
        attrs
    ].concat(_to_consumable_array$2(content))) : elem.apply(void 0, [
        attrs
...
function withTagsCategories(page) {
    return page;
}
...
var SharedLayout = function(param) {
    ...
    ].concat(_to_consumable_array$1(content))), /*#__PURE__*/ h(Footer, {
        hexo: hexo
    })));
};
...
var IconSpan = function(param) {
    var icon = param.icon, hexo = param.hexo;
    for(var _len = arguments.length, content = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++){
        content[_key - 1] = arguments[_key];
    }
    return /*#__PURE__*/ h.apply(void 0, [
        "span",
        {
            class: "info"
        },
        getThemeConfig(hexo).style.post_meta.show_icon ? /*#__PURE__*/ h("i", {
            class: "fa ".concat(icon)
        }) : null,
        "\xa0"
...
var PostMeta = function(param) {
    var hexo = param.hexo, item = param.item;
    var _withTagsCategories_categories_data, _withTagsCategories_categories, _withTagsCategories_tags_data, _withTagsCategories_tags;
    return /*#__PURE__*/ h("section", {
        ...
        class: "date"
    }, hexo.date(item.date, getThemeConfig(hexo).style.post_meta.date_format))), (_withTagsCategories_categories = withTagsCategories(item).categories) === null || _withTagsCategories_categories === void 0 ? void 0 : (_withTagsCategories_categories_data = _withTagsCategories_categories.data) === null || _withTagsCategories_categories_data === void 0 ? void 0 : _withTagsCategories_categories_data.map(function(cat) {
        var _cat_path;
        return /*#__PURE__*/ h(IconSpan, {
            hexo: hexo,
            icon: "fa-folder-o"
        }, /*#__PURE__*/ h("a", {
            href: hexo.url_for((_cat_path = cat.path) !== null && _cat_path !== void 0 ? _cat_path : ''),
            title: cat.name
        }, escapeHtml(cat.name)));
    }), (_withTagsCategories_tags = withTagsCategories(item).tags) === null || _withTagsCategories_tags === void 0 ? void 0 : (_withTagsCategories_tags_data = _withTagsCategories_tags.data) === null || _withTagsCategories_tags_data === void 0 ? void 0 : _withTagsCategories_tags_data.map(function(tag) {
        var _tag_path;
        return /*#__PURE__*/ h(IconSpan, {
            hexo: hexo,
            icon: "fa-tag"
        }, /*#__PURE__*/ h("a", {
            href: hexo.url_for((_tag_path = tag.path) !== null && _tag_path !== void 0 ? _tag_path : ''),
            title: tag.name
        }, escapeHtml(tag.name)));
    }));
};
...
var PostExcerpt = function(param) {
    var hexo = param.hexo, item = param.item;
    var theme = getThemeConfig(hexo);
    var itemSummary = AsRecord(item).summary;
    var excerpt = theme.style.post_excerpt.summary_mode ? itemSummary || hexo.strip_html(item.excerpt || item.content).slice(0, 160) : item.excerpt || itemSummary || item.content;
    return /*#__PURE__*/ h("article", {
        class: "post-container post-excerpt"
    }, /*#__PURE__*/ h("header", {
        class: "post-title"
    }, /*#__PURE__*/ h("h3", null, /*#__PURE__*/ h("a", {
        href: hexo.url_for(item.path)
    }, titleHTML(item, hexo.date(item.date, 'YYYY-MM-DD'))))), /*#__PURE__*/ h(PostMeta, {
        hexo: hexo,
        item: item
    }), /*#__PURE__*/ h("section", {
        class: "post-body"
...
var index = withHexoData(function(hexo) {
    var _hexo_site_pages_data, _hexo_site_pages, _hexo_site;
    var page_posts = AsRecord(hexo.page).posts.data;
    var theme = getThemeConfig(hexo);
    var index_page = (_hexo_site = hexo.site) === null || _hexo_site === void 0 ? void 0 : (_hexo_site_pages = _hexo_site.pages) === null || _hexo_site_pages === void 0 ? void 0 : (_hexo_site_pages_data = _hexo_site_pages.data) === null || _hexo_site_pages_data === void 0 ? void 0 : _hexo_site_pages_data.find(function(x) {
        return x.source === 'index.md';
    });
    return /*#__PURE__*/ h(SharedLayout, {
        hexo: hexo,
        contentClass: "index-page"
    }, /*#__PURE__*/ h("header", {
        class: "post-container index-post"
    }, /*#__PURE__*/ h("h1", null, escapeHtml(hexo.config.title)), theme.description ? /*#__PURE__*/ h("div", {
        class: "description"
    }, /*#__PURE__*/ h("p", null, theme.description)) : null, (index_page === null || index_page === void 0 ? void 0 : index_page.content) && /*#__PURE__*/ h("div", {
        class: "index-content"
    }, index_page.content)), page_posts.filter(function(item) {
        return item.hidden !== true;
    }).map(function(item) {
        return /*#__PURE__*/ h(PostExcerpt, {
            hexo: hexo,
            item: item
        });
