...
var PostToc = function(param) {
    var hexo = param.hexo, item = param.item;
    if (AsRecord(item).toc && getThemeConfig(hexo).toc_max_depth > 0) {
        var tocHtml = hexo.toc(item.content || '', {
            class: 'toclist',
            list_number: false,
        ...
        return /*#__PURE__*/ h("section", {
            ...
            open: true
        }, /*#__PURE__*/ h("summary", null, i18n(hexo, 'TOC')), /*#__PURE__*/ h("div", {
            class: "toc"
        }, tocHtml)));
    }
    return '';
...
var PostFull = function(param) {
    var hexo = param.hexo, item = param.item;
    return /*#__PURE__*/ h("article", {
        class: "post-container post-full"
    }, /*#__PURE__*/ h("header", {
        class: "post-title"
    }, /*#__PURE__*/ h("h1", null, titleHTML(item))), /*#__PURE__*/ h(PostToc, {
        hexo: hexo,
        item: item
    }), /*#__PURE__*/ h("section", {
        class: "post-body"
    }, item.content), /*#__PURE__*/ h(PostMeta, {
        hexo: hexo,
        item: item
    }));
};
...
var GitalkComment = function(param) {
    var hexo = param.hexo, item = param.item;
    var _getThemeConfig_comment;
    var slot_id = 'gitalk-comment-slot';
    var gitalk = (_getThemeConfig_comment = getThemeConfig(hexo).comment) === null || _getThemeConfig_comment === void 0 ? void 0 : _getThemeConfig_comment.gitalk;
    if (!gitalk) return '';
    var gitalk_config = JSON.stringify({
    ...
    return /*#__PURE__*/ h("div", {
        ...
        onload: "(new Gitalk(".concat(gitalk_config, ')).render("').concat(slot_id, '")')
    }), /*#__PURE__*/ h("div", {
        id: slot_id
    }, "Loading..."));
};
...
var Comment = function(param) {
    ...
    if (((_getThemeConfig_comment = getThemeConfig(hexo).comment) === null || _getThemeConfig_comment === void 0 ? void 0 : _getThemeConfig_comment.enable) === 'gitalk') {
        comment_body = /*#__PURE__*/ h(GitalkComment, {
            hexo: hexo,
            item: item
        });
    } else {
...
var post = withHexoData(function(hexo) {
    var description = hexo.page.description || hexo.strip_html(hexo.page.content).replace(/^\s*/, '').replace(/\s*$/, '').slice(0, 150);
    var title = "".concat(hexo.page.title, " \xb7 ").concat(hexo.config.title);
    return /*#__PURE__*/ h(SharedLayout, {
        hexo: hexo,
        title: title,
        description: description,
        contentClass: "post-page"
    }, /*#__PURE__*/ h(PostFull, {
        hexo: hexo,
        item: hexo.page
