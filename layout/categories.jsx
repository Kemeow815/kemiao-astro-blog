...
var TagsCategoriesLayout = function(param) {
    var hexo = param.hexo, translateKey = param.translateKey, dataSource = param.dataSource;
    var title = "".concat(i18n(hexo, translateKey), " \xb7 ").concat(hexo.config.title);
    var description = title;
    var last_cat = '';
    var sorted_tags = hexo.site[dataSource].data.filter(function(x) {
        return x.name;
    }).sort(function(a, b) {
        return a.name < b.name ? -1 : 1;
    });
    var in_cat = function(name) {
        return /^[0-9]/.test(name) ? '0-9' : /^[a-zA-Z]/.test(name) ? name[0].toUpperCase() : '#';
    };
    var compare_and_update_last_cat = function(tag) {
        var ret = last_cat !== in_cat(tag.name);
    ...
    return /*#__PURE__*/ h(SharedLayout, {
        ...
        contentClass: "tags-page"
    }, /*#__PURE__*/ h("h1", null, i18n(hexo, translateKey)), sorted_tags.map(function(tag) {
        return /*#__PURE__*/ h("template", null, compare_and_update_last_cat(tag) ? /*#__PURE__*/ h("h3", null, in_cat(tag.name)) : null, /*#__PURE__*/ h("span", null, /*#__PURE__*/ h("a", {
            href: hexo.url_for(tag.path)
        }, escapeHtml(tag.name)), " \xd7 ", tag.length, "\xa0\xa0\xa0"));
    }));
};

var categories = withHexoData(function(hexo) {
    return /*#__PURE__*/ h(TagsCategoriesLayout, {
        hexo: hexo,
